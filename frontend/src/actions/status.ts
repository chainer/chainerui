...
export const updateResultSelect = (projectId: string, resultId: string, selected: boolean) => ({
...
export const updateResultFilter = (projectId: string, filterKey: string, filterText: string) => ({
