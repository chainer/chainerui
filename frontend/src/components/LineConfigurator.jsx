    ...
    return (
      <div className="line-configurator">
        ...
        <Form>
          <FormGroup>
            <Label>color</Label>
            <div style={colorBlockStyle} className="mb-2">
              {color}
            </div>
            <Collapse isOpen={this.state.colorPickerCollapse}>
              <ChromePicker color={color} disableAlpha onChange={this.handleLineColorChange} />
            </Collapse>
            <Collapse isOpen={!this.state.colorPickerCollapse}>
              <GithubPicker color={color} width={212} onChange={this.handleLineColorChange} />
            </Collapse>
            <Button onClick={this.togglePicker} size="sm" className="my-2">
              Toggle color picker
            </Button>
            <Button onClick={this.handleResetColorClick} size="sm" className="m-2">
              Reset color
            </Button>
          </FormGroup>
          <FormGroup row>
            <Label htmlFor="line-configurator-select-visibility" className="col-sm-2">
              visibility
            </Label>
            <Col sm={{ size: 10 }}>
              <Check
